...
unsigned int nStakeMinAge = 86400;	//minimum age for coin age:  24h
...
int64 nChainStartTime = 1459901288;
...
const string strMessageMagic = "GlobalTravelCoin Signed Message:\n";
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, const CBlockIndex* pindex)
{
     ...
     if(nPoWHeight < 11 )     	nSubsidy = MAX_MONEY * 0.08;
     else                               nSubsidy = 0;
...
int64 GetProofOfStakeReward(int64 nCoinAge, unsigned int nBits, unsigned int nTime, int nHeight)
{
    ...
    if (nTime < 1554509288) {//0.05% in three years, nChainStartTime + 86400 * 365 * 3
    	nSubsidy *= 5;// 0.5%
    }
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in GlobalTravelCoin
    bool fStrictPayToScriptHash = true; // Always active in GlobalTravelCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "GlobalTravelCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2016年04月06日 19:48 每日比特币：阶梯式飙高";
        CTransaction txNew;
...
//        if( block.hashMerkleRoot != uint256("0xfaa3aba780804551fc734904dae3ad1de22e4f311f2865905757dcd2b352ac2d") )
//			{
...
//        printf("block.nNonce = %u \n", block.nNonce);
        ...
        assert(block.hashMerkleRoot == uint256("0xfaa3aba780804551fc734904dae3ad1de22e4f311f2865905757dcd2b352ac2d"));
...
unsigned char pchMessageStart[4] = { 0x60, 0xc5, 0xc0, 0x10 };
