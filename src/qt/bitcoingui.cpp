...
{
    resize(850, 550);
    setWindowTitle(tr("GlobalTravelCoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a GlobalTravelCoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About GlobalTravelCoin"), this);
    aboutAction->setToolTip(tr("Show information about GlobalTravelCoin"));
    ...
    optionsAction->setToolTip(tr("Modify configuration options for GlobalTravelCoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("GlobalTravelCoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("GlobalTravelCoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to GlobalTravelCoin network.", "", count));
}
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid GlobalTravelCoin address or malformed URI parameters."));
    }
...
{
	 uiInterface.ThreadSafeMessageBox(_("This operation needs your wallet passphrase to unlock the wallet."), _("GlobalTravelCoin"), CClientUIInterface::OK | CClientUIInterface::MODAL);
}
